...
//Arrays for picking a random one of each.
...
document.body.innerHTML += `<h2>Suspects</h2>`
showArrays(suspectsArray)
document.body.innerHTML += `<h2>Weapons</h2>`
showArrays(weaponsArray)
document.body.innerHTML += `<h2>Rooms</h2>`
...
function guessCorrect(){
    ...
    document.body.innerHTML = `<img src=${mystery.suspect.image} width= 500px /><br><em>${mystery.suspect.name}</em>`
